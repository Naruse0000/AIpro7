...
def main():
    ...
    if uploaded_file is not None:
        ...
        if classNo == 0:
            st.subheader(f"これは{pred0}％の確率で「上白石萌歌」です！")
        else:
            st.subheader(f"これは{pred1}％の確率で「上白石萌音」です！")
# mainの起動
...
# 学科：AIシステム科
# 学年：２年
# コメント：今は昔と比べてアプリ開発や機械学習などに簡単かつしっかりと
# 取り組める環境が用意されているんだなと改めて思いました。pythonでコードを書いて
# 機械学習をしていた時に自分ではごちゃごちゃになてしまって困惑したのですが、
#今回使用したTeachable MachineはGUI操作で分かりやすくやり方によっては高精度を
#出せるので便利ですよね。以上です。
#
#=============================================================================#
